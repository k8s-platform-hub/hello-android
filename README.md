...
This is a tutorial aimed at Android application developers who want to build their own backends for their front end apps. By the end of this tutorial you will be able to build mobile applications with the following backend features:
- Authentication (Auth)
...
We are going to clone the `hello-android` project which consists of:
- Boilerplate code for a nodejs server to handle push notifications and a websocket connection
- A basic Android application with working code implementing the various backend features covered in this tutorial

To get the project,

```bash
$ hasura quickstart hasura/hello-android
```

The above command does the following:
- Creates a new directory in your current directory called `hello-android` and clones the content of the `hello-android` project from Hasura Hub into it.
...
### Setting the cluster name in the Android app
...
![Auth SignUp](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/auth-signup.png)
...
![Auth Login](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/auth-login.png)
...
![Auth UserInfo Fail](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/auth-info-fail.png)
...
![Auth UserInfo](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/auth-info.png)
...
![Auth CodeGen Button](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/auth-codegen-button.png)

Select your required language and library from the drop down on the left.
- For Android select `Java Android`

![Auth CodeGen](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/auth-codegen.png)
...
![Data Tab](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-tab.png)
...
![Data CreateTable](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-createtable.png)
...
![Data Permissions](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions.png)
...
![Data Permissions Insert](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-insert.png)
...
![Data Permissions Select](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-select.png)
...
![Data Permissions Update](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-update.png)
...
![Data Permissions Delete](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-delete.png)
...
![Data QB Insert](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-insert.png)
...
![Data QB Insert2](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-insert2.png)
...
![Data QB Insert AuthHeader](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-insert-authheader.png)
...
![Data QB Select](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-select.png)
...
![Data QB Select AuthHeader](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-select-authheader.png)
...
![Data CreateTable Edu](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-createtable-edu.png)

Click on the `Create` button.

Similar to `user_details` table, add `user` permissions on the `user_education` table.

![Data Permissions Edu Insert](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-edu-insert.png)

![Data Permissions Edu Select](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-edu-select.png)

![Data Permissions Edu Update](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-edu-update.png)

![Data Permissions Edu Delete](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-permissions-edu-delete.png)
...
![Data Edu FK](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-edu-fk.png)
...
![Data UserDetails REL](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-userdetails-rel.png)
...
![Data UserDetails BrowseRows](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-userdetails-browserows.png)
...
![Data QB Insert Edu](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-insert-edu.png)
...
![Data QB Insert Edu](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-qb-select-rel.png)
...
![Data CodeGen Relation](https://raw.githubusercontent.com/hasura/hello-android/master/readme-assets/data-codegen-rel.png)
...
- Run the Android app
- Click on `Filestore` in the landing screen to see a working example of this.
- The code can be found in the `FilestoreActivity.java` file.
...
FirebaseCloudMessaging(FCM) are used to send push notifications to Android devices. This project makes use of FCM for its push notification needs. Follow the instructions given in their docs to integrate Firebase into your Android app.
